...
const AnimatedTriangle = memo(({ size, startX, startY, color, duration, others = [] }) => {
    ...
    return (
        <div className="fixed pointer-events-none z-0" style={{
            ...
            <div style={{ width: '100%', height: '100%', animation: `spin ${duration}s linear infinite` }}>
                <svg viewBox="0 0 100 100" width="100%" height="100%" preserveAspectRatio="none"
                    style={{ filter: `drop-shadow(0 0 5px ${color})` }}>
                    <polygon points="50,0 0,100 100,100"
                        style={{ fill: 'transparent', stroke: color, strokeWidth: 2, vectorEffect: 'non-scaling-stroke' }} />
                </svg>
            </div>
        </div>
    );
...
BuilderIoPage.displayName = 'BuilderIoPage';
